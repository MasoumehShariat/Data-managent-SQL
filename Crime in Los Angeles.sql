...
from report
INNER JOIN crime on report.CrimeCode=crime.CrimeCode
...
######### Adding integrity constraints to one or more tables. Add these constraints : UNIQUE, check,not null ,primary key
